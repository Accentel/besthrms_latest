...
<?php 
    ...
    <img src="images/kvrbest.jpg" alt="Centered Image">
        ...
        Further to your application & subsequent interview, we have pleasure to appoint you as a  <b><?php echo $designation; ?></b>&nbsp;on the following terms and conditions:<br><br>
            1.	Your employment shall be for a Fixed Term of Eleven <b>(11) Months</b> commencing from <br> <b><?php echo date("d-m-Y", strtotime($fromdate)); ?></b> and shall automatically end on <b><?php echo date("d-m-Y", strtotime($todate)); ?></b>.<br><br>2. Your monthly emoluments will be as under: </P>
