...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>KVR BEST THE IFMS COMPANY</title>
	...
	<body class="login-layout" style="background-image: url('kvrbest.jpeg');background-repeat: no-repeat;width:100%;height:100%;background-color:white;background-position: top;">
